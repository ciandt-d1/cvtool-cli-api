...
class JobStep(Model):
    ...
    """
    def __init__(self, job_id: str=None, version: str=None, status: str=None, exit_status: str=None, exit_message: str=None, create_time: datetime=None, start_time: datetime=None, end_time: datetime=None, last_updated: datetime=None):
        """
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'JobStep':
        """
