...
class Job(Model):
    ...
    """
    def __init__(self, id: str=None, version: str=None, type: str=None, status: str=None, exit_status: str=None, exit_message: str=None, create_time: datetime=None, start_time: datetime=None, end_time: datetime=None, last_updated: datetime=None, created_by: str=None, input_params: JobInputParameters=None):
        """
    ...
    @exit_message.setter
    def exit_message(self, exit_message: str):
        """
